                ...
                <div className="mt-4 p-3 rounded-xl border border-zinc-800 bg-zinc-900/60 text-xs leading-5">
                    <details>
                        ...
                        <ul className="list-disc ml-6 space-y-1">
                            ...
                            <li>Each door has hidden dimensions generated by the system.</li>
                            <li>The existing bug is in how the average is calculated and compared.</li>
                            <li>The real exit door satisfies area ≈ 3 * (average area of all other doors).</li>
                            <li>You can use console.log() to print debug information.</li>
                        </ul>
                    </details>
                </div>
            </div>
